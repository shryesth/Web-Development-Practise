...
app.get("/filter", (req, res) => {
  ...
  const foundJoke = jokes.find((joke) => joke.jokeType == type)
  res.json(foundJoke)
})
...
app.post("/jokes", (req, res) => {
  ...
  const newJoke = {
    id: jokes.length + 1, jokeText: req.body.jokeText, jokeType: req.body.jokeType
  }
...
app.put("/jokes/:id", (req, res) => {
  const id = parseInt(req.params.id)
  // const newText = req.body.jokeText
  // const newType = req.body.jokeType
...
app.delete("/jokes/:id", (req, res) => {
  ...
  if (searchIndex > -1) {
    ...
    res.status(404).json({ error: `Joke with id: ${id} not found. No jokes deleted` })
  }
})
...
app.delete("/all", (req, res) => {
  if (masterKey === req.query.key) {
    ...
    res.sendStatus(404).json({ error: `you are not allowed to perform this action` })
  }
})
